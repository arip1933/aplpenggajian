...
class Welcome extends CI_Controller {
	...
	public function index()
	{
		...
		if($cek == FALSE)
		{
			$this->session->set_flashdata('pesan','<div class="alert alert-danger alert-dismissible fade show" role="alert"> <setrong>Username Atau Password Anda Salah!!!</setrong>
